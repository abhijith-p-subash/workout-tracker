import { IonButton, IonButtons, IonCol, IonContent, IonDatetime, IonHeader, IonIcon, IonInput, IonItem, IonLabel, IonMenuButton, IonPage, IonPopover, IonRow, IonSelect, IonSelectOption, IonTitle, IonToast, IonToolbar, useIonViewWillEnter } from '@ionic/react'
import { useHistory, useParams } from "react-router";
import { calendarOutline, checkmark, close, sync } from 'ionicons/icons'
            ...
            <IonContent>
                ...
                <div className='ion-margin-vertical ion-padding'>
                    <IonItem>
                        ...
                        <IonInput type='text' name='name' value={user.name} onIonChange={(e) => handleChange(e)}></IonInput>
                    </IonItem>
                    <IonItem>
                        <IonLabel position="floating">Email</IonLabel>
                        <IonInput disabled type='email' name='email' value={user.email} onIonChange={(e) => handleChange(e)}></IonInput>
                    </IonItem>
                    <IonItem>
                        <IonLabel position="floating">Phone</IonLabel>
                        <IonInput type='text' name='phone' value={user.phone} onIonChange={(e) => handleChange(e)}></IonInput>
                    </IonItem>
                    <IonItem>
                        <IonLabel position="floating">Gender</IonLabel>
                        <IonSelect value={user.gender} name="gender" placeholder="Select One" onIonChange={(e) => handleChange(e)}>
                    ...
                    <IonItem>
                        ...
                        <IonInput type='text' name='blood' value={user.blood} onIonChange={(e) => handleChange(e)}></IonInput>
                    </IonItem>
                    <IonItem>
                        <IonLabel position="floating">Height (cm)</IonLabel>
                        <IonInput type='number' name='height' value={user.height} onIonChange={(e) => handleChange(e)}></IonInput>
                    </IonItem>
                    <IonItem>
                        <IonLabel position="floating">Weight (Kg)</IonLabel>
                        <IonInput type='number' name='weight' value={user.weight} onIonChange={(e) => handleChange(e)}></IonInput>
                    </IonItem>
                </div>
