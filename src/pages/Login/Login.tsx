            ...
            <IonContent fullscreen className="ion-padding ion-margin">
                    ...
                    <IonCol sizeMd="6" offsetMd="3">
                        <IonList>
                            ...
                            <IonItem>
                                ...
                                <IonInput minlength={6} value={loginData.password} onIonChange={(e) => handleChange(e)} type="password" name="password" required></IonInput>
                            </IonItem>
                        </IonList>
                    </IonCol>
                </IonRow>
                <IonRow>
                    <IonCol sizeMd="6" offsetMd="3">
                        ...
                        <IonButton type="submit" onClick={(e) => handleSubmit(e)} expand="block" color="primary">
                            Login
                        </IonButton>
                    </IonCol>
                </IonRow>
