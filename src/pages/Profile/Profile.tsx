      ...
      <IonContent>
        ...
        <IonHeader>
          <IonToolbar color="primary">
            ...
            <IonButtons slot="end">
              <IonButton
                onClick={() => history.push(`/update-profile/${user.id}`)}
                id="watch"
              >
            ...
            <div className="img-wrapper">
              ...
              <IonButton color="light">
                {auth.currentUser?.emailVerified ? (
                  <AiFillCheckCircle style={{ color: "rgb(0, 110, 255)" }} />
                ) : (
          ...
          {segment === "health" && (
            <div className="ion-margin-vertical" color="medium">
              ...
              <IonItem>
                ...
                ></IonIcon>
                <IonLabel>
                  {user.height ? user.height : "Height in "} cm
                </IonLabel>
              </IonItem>
              <IonItem>
                <IonIcon
                ...
                ></IonIcon>
                <IonLabel>
                  {user.weight ? user.weight : "Weight in "}kg
                </IonLabel>
              </IonItem>
            </div>
          )}
